        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li class="active">
                ...
                <ul class="nav nav-second-level">
                    ...
                    <li><a href="{{ route('dashboard-1') }}">Dashboard v.1</a></li>
                    <li><a href="{{ route('dashboard-2') }}">Dashboard v.2</a></li>
                    <li><a href="{{ route('dashboard-3') }}">Dashboard v.3</a></li>
                    <li><a href="{{ route('dashboard-4') }}">Dashboard v.4 <span class="label label-primary pull-right">NEW</span></a></li>
                </ul>
            </li>
            <li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{route('graph_flot')}}">Flot Charts</a></li>
